...
@pytest.mark.parametrize(
    "mock_rulebooks",
    get_tests_data("annet/test_inherit/test_deploying/test_invalid_cases"),
...
def test_invalid_cases(mock_rulebooks):
    ...
    with pytest.raises(RulebookSyntaxError) as exc_info:
        rb_provider._get_rulebook_by_extension(rulebook_path="child", extension="deploy", hw=hw, vendor=vendor)
