...
DiffItem: TypeAlias = tuple[str, str, "Diff", dict[Any, Any]]
...
class OldNewResult:
    ...
    def __init__(
        ...
        new_files: MutableMapping[str, Any] | None = None,
        old_files: MutableMapping[str, Any] | None = None,
        ...
        safe_new_files: MutableMapping[str, Any] | None = None,
        ...
        self.new_files: MutableMapping[str, Any] = new_files if new_files else {}
        self.old_files: MutableMapping[str, Any] = old_files if old_files else {}
        ...
        self.safe_new_files: MutableMapping[str, Any] = safe_new_files if safe_new_files else {}
    ...
    def get_new_files(self, safe: bool = False) -> MutableMapping[str, Any]:
        if safe:
